...
import RotateRightIcon from '@mui/icons-material/RotateRight'; // Import RotateRightIcon
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Button
            ...
            sx={{ mt: 3, fontSize: 18, color: "#000" }}
            disabled={isPending}
            startIcon={isPending ? <RotateRightIcon sx={{ animation: 'spin 1s linear infinite' }} /> : null} 
          >
            <b>{isPending ? "Creating..." : "Create Product"}</b>
          </Button>
        </form>
